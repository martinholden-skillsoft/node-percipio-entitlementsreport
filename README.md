# node-percipio-entitlementsreport

Retrieve [License Consumption Report](https://documentation.skillsoft.com/en_us/percipio/Content/A_Administrator/admn_rpt_entitlements.htm) data from Percipio and save locally.
...
Make any additional config changes in [config/default.js](config/default.js) file, to specify the request criteria for the report other than date ranges.
